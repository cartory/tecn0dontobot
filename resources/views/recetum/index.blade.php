                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('receta.destroy',$recetum->id) }}" method="POST">
                                                    <a 
                                                        title="show"
                                                    class="btn btn-sm btn-primary " href="{{ route('receta.show',$recetum->id) }}"><i class="fa fa-fw fa-eye"></i></a>
                                                    <a 
                                                        title="edit"
                                                    class="btn btn-sm btn-success" href="{{ route('receta.edit',$recetum->id) }}"><i class="fa fa-fw fa-edit"></i></a>
                                                    @csrf
                                                    @method('DELETE')
                                                    <button 
                                                        title="delete"
