                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('odontologos.destroy',$odontologo->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('odontologos.show',$odontologo->id) }}"><i class="fa fa-fw fa-eye"></i> Show</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('odontologos.edit',$odontologo->id) }}"><i class="fa fa-fw fa-edit"></i> Edit</a>
                                                    @csrf
                                                    @method('DELETE')
