						...
						<div class="wrap">
							...
							<div class="manage-menus">
								<form method="get" action="{{ $currentUrl }}">
									<label for="menu" class="selected-menu">Selecciona el menu a editar:</label>
														...
														<div class="inside">
															<div class="customlinkdiv" id="customlinkdiv">
																...
																<p id="menu-item-role_id-wrap">
																	<label class="howto" for="custom-menu-item-name"> <span>Rol</span>&nbsp;
											...
											<div class="menu-edit ">
												<div id="nav-menu-header">
													<div class="major-publishing-actions">
														<label class="menu-name-label howto open-label" for="menu-name"> <span>Nombre</span>
												...
												<div id="post-body">
													<div id="post-body-content">
														...
														<div class="drag-instructions post-body-plain" style="">
															<p>
															 Por favor pon el nombre y presiona el boton "Crear Menu"
															</p>
														</div>
														@endif
															...
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
																	...
																	<div class="menu-item-actions description-wide submitbox">
																		...
																		<span class="meta-sep hide-if-no-js"> | </span>
																		<a onclick="getmenus()" class="button button-primary updatemenu" id="update-{{$m->id}}" href="javascript:void(0)">Actualizar objeto</a>
												...
												<div id="nav-menu-footer">
													<div class="major-publishing-actions">
														...
														@elseif(request()->has("menu"))
														<span class="delete-action"> <a class="submitdelete deletion menu-delete" onclick="deletemenu()" href="javascript:void(9)">Borrar menu</a> </span>
														<div class="publishing-action">
